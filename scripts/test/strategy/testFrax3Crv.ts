...
async function deposit(): Promise<void> {
    console.log("Balance lp: ", ethers.utils.formatEther(await utilsTask.getBalanceERC20(depositAccount1.address, info.wantAddress)))
    await erc20Task.approve(info.wantAddress, depositAccount1, sCompVault.address, ethers.constants.MaxUint256);
