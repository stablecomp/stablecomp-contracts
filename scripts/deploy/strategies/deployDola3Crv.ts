...
main()
    .then(async () => {
        ...
        await strategyTask.setTokenSwapPathConfig(sCompStrategy.address, "crv_dola")
        await strategyTask.setTokenSwapPathConfig(sCompStrategy.address, "cvx_dola")
