...
contract StrategyCurveLPAVAX is StratManager, FeeManager, GasThrottler {
    ...
    constructor(
        ...
        address _strategist
    ) StratManager(_strategist) public {
        want = _want;
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (wantBal < _amount) {
            IRewardsGauge(rewardsGauge).withdraw(_amount.sub(wantBal), true);
    ...
    function _harvest() internal {
        ...
        IRewardsGauge(rewardsGauge).claimable_reward(address(this), address(crv));
