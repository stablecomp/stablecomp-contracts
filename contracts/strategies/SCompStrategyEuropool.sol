...
/*
    ...
    * Changed to purchase bveCVX via Curve Factory Pool
    ...
    - Remove keeper
*/
contract SCompStrategyEuropool is
BaseStrategy,
CurveSwapper,
UniswapSwapper,
TokenSwapPathRegistry
{
    ...
    address public constant feiUsdc = 0x956F47F50A910163D8BF957Cf5846D573E7f87CA;
    ...
    function initialize(
        ...
        path[2] = feiUsdc;
        path[3] = agEur;
        _setTokenSwapPath(crv, agEur, path);
        ...
        path[1] = weth;
        path[2] = agEur;
        _setTokenSwapPath(cvx, agEur, path);
    }
