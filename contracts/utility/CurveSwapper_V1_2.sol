...
import "../interface/ICurveFi_V1_2.sol";
...
*/
contract CurveSwapper_V1_2 is BaseSwapper {
    ...
    function _exchange(
        ...
        if (poolAddress != address(0)) {
            ...
            ICurveFi_V1_2(poolAddress).exchange(i, j, _dx, _min_dy);
        }
    }
    ...
    function _add_liquidity_single_coin(
        ...
        if (numPoolElements == 2) {
            ...
            ICurveFi_V1_2(swap).add_liquidity(convertedAmounts, min_mint_amount);
    ...
    function _add_liquidity(
        ...
        ICurveFi_V1_2(pool).add_liquidity(amounts, min_mint_amount);
    }
    ...
    function _remove_liquidity_one_coin(
        ...
        ICurveFi_V1_2(swap).remove_liquidity_one_coin(_token_amount, i, _min_amount);
    }
}
